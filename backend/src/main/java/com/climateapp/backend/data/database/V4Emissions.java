...
@Entity
@Table (name = "v4_emissions" )
public class V4Emissions {
    ...
    public V4Emissions(String year, Object[] countries){
        this.year = year;
        this.countries = new Double[countries.length];
        for(int i = 0; i < countries.length; i++){
            this.countries[i] = (Double) countries[i];  
        }
    }
